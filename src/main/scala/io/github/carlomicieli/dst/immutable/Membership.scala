 ...
 *    oddNumbers: io.github.carlomicieli.dst.immutable.Membership[Int] = <membership>
 *
 ...
 *    positiveNumbers: io.github.carlomicieli.dst.immutable.Membership[Int] = <membership>
 *
 *    scala> val positiveAndOddNumbers = positiveNumbers intersection oddNumbers
 *    positiveAndOddNumbers: io.github.carlomicieli.dst.immutable.Membership[Int] = <membership>
 *
